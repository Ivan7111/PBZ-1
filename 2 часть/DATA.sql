USE data2;
INSERT INTO Suppliers (SupplierNumber, SupplierName, SupplierStatus, City)
	VALUES ('П1', 'Петров', 20, 'Москва'),
	('П2', 'Синицин', 10, 'Таллинн'),
	('П3', 'Федоров', 30, 'Таллинн'),
	('П4', 'Чаянов', 20, 'Минск'),
	('П5', 'Крюков', 30, 'Киев');
INSERT INTO Parts (PartNumber, PartName, Colour, Size, City)
...
INSERT INTO Projects (ProjectNumber, ProjectName, City)
	...
	('ПР6', 'ИПР6', 'Саратов'),
	('ПР7', 'ИПР7', 'Москва');
INSERT INTO PartsBySupplier (SupplierNumber, PartNumber, ProjectNumber, NumberOfParts)
